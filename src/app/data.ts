...
export const customer = {
  ...
  customerStateDetail: {
    ...
    decisionRelevantTraits: [
      {
        label: "决策结构",
        ontologyTypeLabel: "决策结构",
        stabilityLabel: "稳定",
        value: "已婚，配偶已加入决策",
        impact: "当前关系模式已从单人评估转向双人协商，关键动作需面向双方共同推进。",
        modelImplication: ["customer model 需从个人偏好切换为双人决策结构。", "后续触达动作应默认评估配偶参与度与否决权。"],
        evidenceSummary: ["客户明确提到配偶已加入选车讨论。", "近期任务已转向家庭体验邀约。"],
        relations: { relatedTo: ["关系模式", "角色分工"], impacts: ["任务编排", "沟通对象", "推进路径"] },
      },
      {
        label: "信息偏好",
        ontologyTypeLabel: "信息偏好",
        stabilityLabel: "稳定",
        value: "理性比对型，重视实测与参数对照",
        impact: "当前动作更适合提供对比材料与实测证据，而不是直接推进情绪型逼单。",
        modelImplication: ["customer model 应优先沉淀可对比、可验证的信息资产。", "推荐动作需偏证据型表达而非强销售话术。"],
        evidenceSummary: ["客户多次围绕参数与实测体验提问。", "试驾后对技术体验的反馈具体且可复述。"],
        relations: { relatedTo: ["证据偏好", "沟通方式"], impacts: ["材料准备", "销售话术"] },
      },
      {
        label: "预算边界",
        ontologyTypeLabel: "预算约束",
        stabilityLabel: "待复核",
        value: "35 至 42 万元，存在明确上限",
        impact: "价格 objection 会持续影响推进节奏，金融方案验证前不适合定型报价策略。",
        modelImplication: ["customer model 当前存在预算上限约束，但边界仍需金融能力验证。", "报价策略应与月供承受能力绑定，而非只看裸车价格。"],
        evidenceSummary: ["客户持续表达对价格区间的抵触。", "尚未完成月供与金融方案试算。"],
        relations: { relatedTo: ["预算边界", "金融承受力"], impacts: ["报价节奏", "配置推荐", "金融方案"] },
      },
      {
        label: "时间窗口",
        ontologyTypeLabel: "时间窗口",
        stabilityLabel: "易变",
        value: "春节前提车意愿明确，实际窗口约 3 周",
        impact: "若 1 至 2 周内无法收敛家庭共识，将直接压缩成交推进与交付排产窗口。",
        modelImplication: ["customer model 需要记录一个短期成交窗口。", "若家庭共识延迟，状态可能快速从推进转为观望。"],
        evidenceSummary: ["客户表达过春节前提车意愿。", "配偶加入决策后时间线可能延长 1 至 2 周。"],
        relations: { relatedTo: ["成交窗口", "家庭共识"], impacts: ["邀约时机", "交付排产"] },
      },
    ],
    actionable: [
      {
    ...
    keyValidationItems: [
      {
        ...
        judgmentImpact: "关系模式 / 核心 objection",
        actionImpact: "当前不宜直接进入成交推进，否则动作会建立在错误阻力判断上。",
        verificationMethod: "安排双人体验沟通，直接确认配偶核心顾虑。",
        relatedTo: ["配偶角色", "核心异议", "家庭决策"],
      },
      {
        priority: "P1",
        title: "金融承受区间未确认",
        ...
        judgmentImpact: "推荐动作 / 报价策略",
        actionImpact: "报价节奏不能定型，容易提前触发价格防御。",
        verificationMethod: "提供金融方案试算，并确认月供接受范围。",
        relatedTo: ["预算边界", "金融方案", "报价策略"],
      },
      {
        priority: "P2",
        title: "售后承诺文件未核实",
        ...
        judgmentImpact: "服务信任",
        actionImpact: "会削弱服务信任说服力，也无法确认是否适合推进签约相关动作。",
        verificationMethod: "补充售后服务响应说明或承诺材料。",
        relatedTo: ["服务信任", "售后承诺", "签约推进"],
      },
    ],
    tension: {
      title: "智能体验诉求 vs 家庭品牌与价格顾虑",
      tensionTitle: "智能体验诉求 vs 家庭品牌与价格顾虑",
      leftLabel: "想要更强智能体验",
      leftForceLabel: "体验拉力",
      ...
      evidenceEntries: ["第二次试驾后对辅助驾驶体验满意", "客户明确提到配偶尚未参与决策", "客户持续表达对价格区间的抵触"],
