...
export default function SalesPage() {
  ...
  const candidates = {
    ...
    tension: {
      ...
      signalCount: "Based on 3 signals",
      currentBiasLabel: "当前偏向",
      ...
      evidenceEntries: ["「他老婆更想买奔驰」→ 配偶主动偏好", "「觉得不够档次」→ 品牌感知障碍", "「价格高了点」→ 价格阻力确认"],
      reviewActions: { toggleEvidence: "查看证据来源", collapseEvidence: "收起证据来源", markChanged: "标记张力已变化", markIncorrect: "标记系统判断有误" },
    },
  } as const;
